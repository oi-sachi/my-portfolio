    ...
    <>
            ...
            <div className='md:w-1/3 p-4'>
              <div className='bg-gray-100 rounded-lg p-8'>
                <div className='flex items-center mb-3'>
                  ...
                  <h2 className='text-gray-900 text-lg font-medium'>SNS Chat App</h2>
                </div>
                <div>
                  <p>ReactとJavaScriptで投稿機能付きのチャットアプリ、仕様はreact, JavaScript, HTML, CSS, firebase, AWS, ログイン・ログアウト認証機能、メッセージ投稿機能、検索機能、お気に入りの登録機能を実装しています。</p>
      ...
      <section className='text-gray-700 border-t border-gray-200'>
        <div className='container px-5 py-24 mx-auto flex flex-wrap'>
          {/* left side */}
          <div className='mb-10 lg:mb-0 e-full lg:w-1/2 flex justify-center'>
